...
2.  Identify (at least) three ways in which this proposal can go wrong.

## A Simple Conceptual Framework

Borrego & Henderson (2014) looked at how to increase adoption of evidence-based teaching strategies in STEM:
...
-   Two kinds of knowledge:
    -   **Techne** is hard-and-fast rules, often derived from first principles
...
2.  What have you learned in your current role that qualifies as *techne*? As *metis*?
