...
The diffusion of innovations model describes how change spreads:
...
1.  *Use existing social ties*
    -   Successful movements are built on pre-existing relationships
...
4.  Pick something that is *immediately useful*
    -   Remember, most innovations languish or are met with passive resistance
...
-   **Decision Owners** actually have the authority to make the change
